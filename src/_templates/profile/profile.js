            ...
            <Grid container spacing={2} padding={2}  >
                <Grid item xs={12} >
                    <Paper style={{ textAlign: "center" }}>
                        ...
                        <IconButton onClick={()=>{setDialog(true)}} color='info'>
                          
                                <Avatar sx={{ width: 150, height: 150 }} src={profile_path}  alt={user.user.fname.toUpperCase()}    >
            ...
            <Grid container spacing={2} padding={2} >
               ...
               <Paper >
                ...
                <Grid item xs={6}>
                    ...
                    <OutlinedInput size='small' fullWidth  disabled value={email}/>
                </Grid>
                <Grid item xs={6}>
