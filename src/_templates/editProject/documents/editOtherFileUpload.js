...
const EditOtherFileUpload = () => {
    const data = useSelector(state => state.editData)
    const docs = (data.documents)
    const [files, setFiles] = useState(docs?.others ? [...docs?.others] : []);
    ...
    useEffect(() => {
        ...
        documentsData = {
            ...documentsData,
            ... {
                others: uploadedFiles.map((data) => { return (data) })
            }
        }
        let preDocumentsData = data.prevDocuments
        preDocumentsData = {
            ...preDocumentsData, ...{
                others: prevOthers.toString()
            }
        }
    ...
    const handleDeletePrevFiles =async (filename,indexT) => {
        ...
        setPrevOthers((prevItems) => prevItems.filter((_, index) => index !== indexT));      
    }
    return (
        <div>
                                ...
                                return (
                                    <ListItem>
                                        ...
                                        <ListItemSecondaryAction>
                                            ...
                                            <IconButton color='error' onClick={() => { handleDeletePrevFiles(index) }}>
                                                <DeleteIcon />
                                            </IconButton>
                                        </ListItemSecondaryAction>
                                    </ListItem>
...
export default EditOtherFileUpload;
